...
const (
	...
	RagService_InspectFile_FullMethodName = "/rag.v1.RagService/InspectFile"
)
...
type RagServiceClient interface {
	...
	InspectFile(ctx context.Context, in *InspectFileRequest, opts ...grpc.CallOption) (*InspectFileResponse, error)
}
...
func (c *ragServiceClient) InspectFile(ctx context.Context, in *InspectFileRequest, opts ...grpc.CallOption) (*InspectFileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InspectFileResponse)
	err := c.cc.Invoke(ctx, RagService_InspectFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RagServiceServer interface {
	...
	InspectFile(context.Context, *InspectFileRequest) (*InspectFileResponse, error)
...
func (UnimplementedRagServiceServer) InspectFile(context.Context, *InspectFileRequest) (*InspectFileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InspectFile not implemented")
}
...
func _RagService_InspectFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InspectFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RagServiceServer).InspectFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RagService_InspectFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RagServiceServer).InspectFile(ctx, req.(*InspectFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RagService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RagService_InspectFile_Handler,
		},
	},
